---
title: <center><font size="6"><b>Testing alignments</b></font></center>
...
```{r alignments real songs, eval = FALSE, echo = FALSE}
...
-  Higher same category costs produce the highest gap difference
