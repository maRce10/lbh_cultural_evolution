...
* Summarize results revBayes trees
    - [MCMC, ML and P3 diagnostics](https://rpubs.com/marcelo-araya-salas/686275)
...
=======
    - [MCMC, ML and P3 diagnostics](hhttps://rpubs.com/marcelo-araya-salas/681895)
    -  [diagnostic plots](lbh_cultural_evolution/tree/master/output/MCMC_diagnostic_plots)
...
* Run revbayes posterior predictions (P3)
* Summarize results revBayes trees
* Add info about number of iterations to MCMC diagnostics HTML
