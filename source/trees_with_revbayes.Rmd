...
done <- unique(sapply(current.output, function(x) paste(strsplit(x, "_",fixed = TRUE, "[[", 1)[[1]][1:4], collapse = "_"), USE.NAMES = FALSE))
...
```{r revbayes loop global model, eval = FALSE, echo = TRUE}
