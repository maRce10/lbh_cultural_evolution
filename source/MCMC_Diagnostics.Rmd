...
x <- c("pbapply", "parallel", "coda", "DT", "stringr", "rwty")
...
knitr::kable(as.matrix(table(model_diags$iterations, model_diags$lek)), caption = "Number of models by iterations and lek")
