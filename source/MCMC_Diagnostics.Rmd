...
```{r plot traces, eval = TRUE, fig.height = 3.3, fig.width = 30, warning = FALSE, message = FALSE, dpi = 30}
...
# loop to make plots
out <- lapply(base_models, function(x){
  ...
  return(chain)  
    ...
    out2 <- try(plot_traces(X = out, clms = 8, cex = 2.5), silent = TRUE)
